...
final verifyTokenProvider = ChangeNotifierProvider.autoDispose(
    (ref) => getIt.get<EmailVerificationViewModel>());
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      AppTextView.getAppTextViewBold(AppStrings.verifyItsYou),
                      const SizedBox(
                        height: 12,
                      ),
                      AppTextView.getAppTextView(
                          "We send a code to ( ${arg.first} ). "
                      ...
                      PinCodeTextField(
                        ...
                        pinTheme: PinTheme(
                          ...
                          inactiveColor: ThemeConfig.greyColor.withOpacity(0.1),
                ...
                Sized24Container(
                  child: AppButton(
                      ...
                      enabled:
                          model.otpController.text.length == 5 ? true : false),
                ),
              ],
            ),
          ),
